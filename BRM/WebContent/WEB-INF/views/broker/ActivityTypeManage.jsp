...
$(document).ready(function(){
	...
	function add(){
		parent.showFrame('添加活动类型','brokerPage?page=ActivityType',430,200);
	}
	function edit(){
		var row=$("#list").jqGrid('getGridParam','selrow');
		if(row == null){alert("请选择要修改的数据");return;}
		parent.showFrame('修改活动类型','findQuestionTestTypeById?id='+row,430,200);
	}
	function search(){
