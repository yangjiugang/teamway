...
$(document).ready(function(){
	...
	function add(){
		parent.showFrame('添加问卷类型','brokerPage?page=PaperType',430,200);
	}
	function edit(){
		var row=$("#list").jqGrid('getGridParam','selrow');
		if(row == null){alert("请选择要修改的数据");return;}
		parent.showFrame('修改问卷类型','findQuestionPaperTypeById?id='+row,430,200);
	}
	function search(){
