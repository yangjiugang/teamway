...
<script type="text/javascript">
	...
	function reload(){
		document.getElementById("right").src = "RewardPunishmentManagement";
	}
...
<!--中间-->
<div class="middle">
	<iframe id="left" name="left" src="RewardPunishmentManagementLeft" frameborder="0" class="left"></iframe>
    <div id="line" style="float:left; background-color:#7fb5dc; width:1px; height:100%;cursor:w-resize;"></div>
    <iframe src="RewardPunishmentManagement" name="right" frameborder="0" class="right" id="right"></iframe>
</div>
<!--end中间-->
</body>
</html>