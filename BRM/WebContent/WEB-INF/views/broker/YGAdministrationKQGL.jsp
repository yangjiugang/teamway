...
<div class="middle">
   ...
   <iframe id="left" name="left" src="CheckingInManagementLeft" frameborder="0" class="left"></iframe>
   <div id="line" style="float:left; background-color:#7fb5dc; width:1px; height:100%;cursor:w-resize;"></div>
   <iframe src="CheckingInManagement" name="right" frameborder="0" class="right"></iframe>
</div>
<!--end中间-->
</body>
</html>