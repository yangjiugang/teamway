...
<script>
	function showFrame(title,src,width,height){
		ShowIframe(title,src,width,height);
	}
	...
	function setPersonnelSrc(type){
		document.getElementById("rightFrame").src="external_frameJsp?jsp=Personnel&type="+type;
	}
</script>
</head>
...
<div class="head">
    ...
    <div class="top_right">
    	<ul>
            ...
            <li><a href=""><span><img src="images/top_sz.jpg" /></span> 系统设置</a></li>
        </ul>
        <h1>房立方地产经纪人管理系统</h1>
    </div>
</div>
...
<div class="tab1">
    <ul>
       ...
       <li><a href="BirthdayRemind">生日提示</a></li>
     </ul>
</div>
...
<div class="middle">
	<div class="left">
        <form>
        <dl>
        	<dt> <img src="images/tree2.jpg" onclick="setPersonnelSrc(0)"/>全部</dt>
    ...
    <!-- 隐藏超链接域 -->
    <iframe src="external_frameJsp?jsp=Personnel&type=" id="rightFrame" name="right" frameborder="0" class="right"></iframe>
</div>
<!--end中间-->
</body>
</html>
