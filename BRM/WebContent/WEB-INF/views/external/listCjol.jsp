...
<!--end中间选项卡，面包屑-->
<!--中间-->
	<form name="myform" id="myform" action="searchCjol" method="post">
         <input type="hidden" name="eventTarget" id="eventTarget" value="" /><!-- 分页 -->
         <input type="hidden" name="eventargument" id="eventargument" value="" /><!-- 下载简历 -->
         <input type="hidden" name="validation" id="validation" value="${validation}" />
         <input type="hidden" name="cjolstateid" id="cjolstateid" value="${cjolstateid}" />
         <input type="hidden" name="updateTime" id="updateTime" value="${parameter.updateTime}" />
         <input type="hidden" name="location" id="location" value="${parameter.location}" />
         <input type="hidden" name="checkboxId" id="checkboxId" value="" />
		<div style="text-align: center;border-bottom: 1px solid #A8CBFE">
			...
			<input type="text" id="key" name="key" value="${parameter.key}"  style="width:450px;"><font color="red">*</font>
			<input type="button" class="seach_but" onclick="searchResume();" value="&nbsp;搜&nbsp;索&nbsp;"/>
			
		</div>
		<div style="text-align: center;border-bottom: 1px solid #A8CBFE">
			<font color="red">${labMessage}</font> 
		</div>
			           ...
			           <tr>
			               <td align="center" rowspan="2">
			                   <input type="checkbox"
			                   		  ...
			                   		  id="${userResume.checkboxId }" 
			                   		  resumeId = "${userResume.resumeUserId }" 
			                   		  name="idList" />
			               </td>
