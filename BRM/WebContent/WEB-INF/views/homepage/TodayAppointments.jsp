...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#list").jqGrid({
			...
			datatype: 'json',
			mtype: 'POST',
			colNames: ['id','编号','受访人编号', '受访人姓名','部门','岗位','提醒时间','提醒人'],
...
<div class="r_but05" >
		<div class="R_top">
              <ul class="s_font zp_font">
            	...
            	<ul class="t_but12">
                  	<authz:authorize ifAllGranted="FUNC_AUTH_HOM_09_01"><li><input type="button" class="addftjl" onclick="addCommPage();" /></li></authz:authorize>
  					<authz:authorize ifAllGranted="FUNC_AUTH_HOM_09_02"><li><input type="button" value="查看" class="but1" onclick="queryMoreDetail();" /></li></authz:authorize>
