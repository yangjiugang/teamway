(function($) {
	...
	$.fn.pager = function(options) {
        ...
        function init() { // 分页初始化
        	...
        	bindMove(pageHtml);
        	bindClick(pageHtml);
        	obj.empty().append(pageHtml).append("<span>跳转：<input type=\"text\" class=\"Gotext\" value=\""+curPage+"\"/> 页&nbsp;<input type=\"image\" src=\"images/Go.jpg\" style=\"vertical-align:middle;\"/></span>");
