...
public interface IExamPapersMapper {
	/**
	 * 增加
	 ...
	 * @return
	 */
	public QuestionPapersEmployees findQuestionPapersEmployees(QuestionPapersEmployees questionPapersEmployees);
	 ...
	 * @return
	 */
	public List<QuestionPapersDetail> findQuestionPapersDetail(QuestionPapersDetail qpd);
	 ...
	 * @return
	 */
	public int findQuestionTypeCount(@Param("paperId") int paperId,@Param("questionType") int questionType);
	 ...
	 * @return
	 */
	public int findQuestionPointsCount(@Param("paperId") int paperId,@Param("questionType") int questionType);
