...
public interface ISystemSetMapper {
	/*---------职系设置-----------*/
	/**
	 * 查询职系信息
	 ...
	 *
	 */
	public List<CfgPost> selectJobGrade(CfgPost cjg,@Param("page")Page page);
	/**
	 * 查询所有记录
	 * @param cjg
	 * @return
	 ...
	 * @return
	 */
	public List<CfgPost> selectJobLevel(CfgPost cjg,@Param("page")Page page);
