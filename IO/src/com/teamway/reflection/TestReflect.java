package com.teamway.reflection;
...
public class TestReflect {
	...
	public static void m7() throws InstantiationException, IllegalAccessException {
	...
	private static void m10() throws Exception {
		/*
		 * Class cls = Class.forName("java.lang.String"); Object arr =
		 * Array.newInstance(cls, 10); Array.set(arr, 5, "this is a test"); String s =
		 * (String)Array.get(arr, 5); System.out.println(s);
		 */
