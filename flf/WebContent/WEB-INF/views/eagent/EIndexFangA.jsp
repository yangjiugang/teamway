...
<script type="text/javascript">
	...
	var curStudyPage = ${studyPage.curPage};
	var pageStudyCount = ${studyPage.pageCount};
	$(document).ready(function(){
		$("#page").pager({curPage:curStudyPage, pageSize:10, pageCount:pageStudyCount, goPageCall:goPage});
	});
	
	function goPage(curPage, pageSize) {
		$.fc.ajaxSubmit({
			url:'${pageContext.request.contextPath}/eagent_studyHouseAjax',
			dataType:'json',
...
<!--右边-->
    <div class="FLHRight">
	   ...
	   <div class="Rightleft">
	    <div class="jiange-z">
                  <span class="tltle-wenzi">我学习的房源</span>
                  <span  class="title-line" style="width:414px;"></span>
              </div> 
			<div class="fangy"> 
			
			<c:forEach items="${studyHouses}" var="houses">
					<div class="fangy-c">
						<span class="ico">
