...
<script type="text/javascript">
	...
	var curSkimPage= ${customerSkimPage.curPage};
	var pageSkimCount = ${customerSkimPage.pageCount};
	$(document).ready(function(){
		$("#page").pager({curPage:curSkimPage, pageSize:10, pageCount:pageSkimCount, goPageCall:goPage});
	});
	
	function goPage(curPage, pageSize) {
		$.fc.ajaxSubmit({
			url:'${pageContext.request.contextPath}/eagent_skimHousesAjax',
			dataType:'json',
...
<!--右边-->
    <div class="FLHRight">
	   ...
	   <div class="Rightleft">
	    <div class="jiange-z">
                  <span class="tltle-wenzi">我的客户关注的房源</span>
                  <span  class="title-line" style="width:414px;"></span>
              </div> 
			<div class="fangy" id="fangy"> 
			
			<c:forEach items="${skimHouses}" var="houses">
					<div class="fangy-c">
						<span class="ico">
