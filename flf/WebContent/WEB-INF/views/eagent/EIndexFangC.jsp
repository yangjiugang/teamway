...
<script type="text/javascript">
	...
	var curCollectPage= ${customerCollectPage.curPage};
	var pageCollectCount = ${customerCollectPage.pageCount};
	$(document).ready(function(){
		$("#page").pager({curPage:curCollectPage, pageSize:10, pageCount:pageCollectCount, goPageCall:goPage});
	});
	
	function goPage(curPage, pageSize) {
		$.fc.ajaxSubmit({
			url:'${pageContext.request.contextPath}/eagent_collectHousesAjax',
			dataType:'json',
			...
			callBackFn:function(msg){	
				...
				for(var i=0;i<msg.length;i++){	
					$("#fangy").append("<div class='fangy-c'><span class='ico'><a href='../funlifun/lifang/index-gonggao.html' >"
						...
						+"<a href='../funlifun/lifang/index-gonggao.html'>认售</a>"
...
<!--右边-->
    <div class="FLHRight">
	   ...
	   <div class="Rightleft">
	    <div class="jiange-z">
                  <span class="tltle-wenzi">我的客户收藏的房源 </span>
                  <span  class="title-line" style="width:414px;"></span>
              </div> 
			<div class="fangy" id="fangy"> 
			
			<c:forEach items="${collectHouses}" var="houses">
					<div class="fangy-c">
						<span class="ico">
