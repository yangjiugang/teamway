...
<script type="text/javascript">
	...
	function goPage(curPage, pageSize) {
		alert(curPage+"----"+pageSize);
		 $.fc.ajaxSubmit({
			url:'${pageContext.request.contextPath}/saleHouseAjax',
			dataType:'json',
	...
	<div class="FlhTop">
		...
		<div id="menu">
		     <ul>
              ...
              <li><a href="<%=basePath %>saleHouse?userId=${user.userId}" id="cur">房源</a></li>
...
<!--左边-->
 	<div class="FLHLeft">
        ...
        <ul class="treeNav">
        	...
        	<li>
            	<div class="treefont">
                	<img src="images/1.jpg" /><font><a href="<%=basePath%>shouSaleHouse?userId=${userid }">认售楼盘</a></font>                </div>
                <div class="xian"></div>
            </li> 
            <li>
            	<div class="treefont">
            ...
            <li>
            	<div class="treefont">
                	<img src="images/3.jpg" /><font><a href="Y03juluyuehui.html">记录约会</a></font>
               </div>
              <div class="xian"></div> 	
            </li>
            <li>
            ...
            <li>
            	<div class="treefont">
                	<img src="images/5.jpg" /><font><a href="Y13xiangce.html">传靓照</a></font>               </div>
                <div class="xian"></div>
            </li>
            <li>
            	<div class="treefont">
                	<img src="images/6.jpg" /><font><a href="kaixiaojiluY06.html">记录开销</a></font>
             </div>
                <div class="xian"></div>
            </li>
            <li>
            	<div class="treefont">
                	<img src="images/7.jpg" /><font><a href="HomejiaoyiY4.html">报名（下订单）</a></font>               </div>
                <div class="xian"></div>
            </li>
            <li>
            	<div class="treefont">
                	<img src="images/8.jpg" /><font><a href="HomeTJFXY4.html">推荐分享</a></font>               </div>
                <div class="xian"></div>
            </li>
            <li>
            	<div class="treefont">
