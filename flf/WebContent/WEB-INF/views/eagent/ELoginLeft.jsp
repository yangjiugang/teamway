...
<div class="FLHLeft">
      ...
      <font color="red">用户名或密码错误</font>
            ...
            <form name="f" action="<c:url value='j_spring_security_check'/>" method="POST">
                ...
                <span class="ButtonD"><input type="image" src="images/landingBut.jpg" name="submit" type="submit" onclick='return checkForm();'/><font><a href="forgetPassword?lt=0">忘记密码？</a></font></span>
                <input type="hidden" name="login_type" value="ROLE_0"></input>
            </form>
        </div>
    </div>