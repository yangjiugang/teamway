...
<!--右边-->
	...
	<div class="jiangjie-a">
	 ...
	 <ul class="Y01Result">
        <li>日期</li>
        <li>评论对象类型</li>
        <li style="width:200px;">评论对象名称</li>
        <li style="width:200px;">评论内容</li>

      </ul>

 <c:forEach items="${discussList}" var="discussList">
    <ul class="Y01jg">
      <li><fmt:formatDate value="${discussList.createDate}" type="date"/> </li>
	  <li>${discussList.houseInfoDetail.houseName}</li>
	  <li>${evengList.houseInfoDetail.houseName}</li>
      <li>${discussList.content}</li> 
   </ul>
</c:forEach>
   <ul class="Y01-tong">
