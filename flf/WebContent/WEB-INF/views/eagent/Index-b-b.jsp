...
<!-- 
			<form>
				<div class="Y01Date"
					style="float: left; margin: 30px 0 15px 14px; display: inline;">
...
-->
			...
			<c:forEach items="${discussList}" var="list">
				...
				<li style="width:150px;">${list.customerType}</li>
				<li style="width:150px;">${list.countDiscuss}</li>
				<li><a href="IndexBBB?nameXiangqing=${list.cusId}" class="blue">详情</a></li>
				</ul>
			</c:forEach>
			<!---End Y01首页搜索结果--->
			<ul class="Y01-tong">
