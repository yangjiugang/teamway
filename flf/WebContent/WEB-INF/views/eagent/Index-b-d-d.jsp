...
<div class="FLHRight">
	<div class="jiangjie-a">
        ...
        <li>发团日期</li>
        <li>时长</li>
        <li style="width:150px;">购房团名称</li>
        <li style="width:250px;">参团记录（反馈）</li>
      </ul>
<c:forEach items="${groupList}" var="groupList">
    <ul class="Y01jg">
      <li><fmt:formatDate value="${groupList.houseGroupInfo.groupStartDate}" type="date"/></li>
      <li>${groupList.houseGroupInfo.groupDuration}</li>
      <li style="width:150px;">${groupList.houseGroupInfo.groupName}</li>
      <li style="width:250px;"><c:if test="${groupList.travelStatus == 1}">参加</c:if>
      <c:if test="${groupList.travelStatus == 0}">取消</c:if></li>
   </ul>
  </c:forEach>
     <ul class="Y01-tong">
