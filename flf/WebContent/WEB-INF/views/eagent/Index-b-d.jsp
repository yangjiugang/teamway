...
<li style="width:20px;">至</li>
         ...
         <ul class="Y01homeSOSO" style=" margin:10px 0 0 0;"> 
		   <li></li>
            <li><span><input class="Y01homeSOSOinput" type="text" id="txt" name="txt"  value="请输入...">
             </span>城市：</li>
			 <li></li>
            <li><input class="Y01input" name="searchkey" type="text" value="请输入关键词" onFocus="this.value=''"> <input name="button" type="image" src="images/Y01SOSO.gif"></li>
         </ul>
      </form>
-->	
...
<li style="width:150px;">参加购房团次数</li>
<li></li>
</ul>
...
<li style="width:150px;">${list.countGroup}</li>
<li><a href="IndexBDD?nameXiangqing=${list.cusId}" class="blue">详情</a></li>
</ul>
</c:forEach>
<!---End Y01首页搜索结果--->	
   <ul class="Y01-tong">
<li>统计：<span class="red">${size}</span>条</li>
</ul>
