...
function sikpUrl(){
	window.location.href = "http://127.0.0.1:8080/flf/toelogin";
}
</script>
<body>
<!--头部-->
    ...
    <div class="FLHRight">
		<div class="registerOut">
        	...
        	<span class="zhuce-yan">
               ...
               <span class="zhuce-yan-t">本页面将在5秒后自动跳转，如果没有跳转，请<span class="blue"><a href="http://127.0.0.1:8080/flf/toelogin" class="red">点击此处</a></span></span>
