...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		function goPage(curPage, pageSize){
			document.forms["houseOrderForm"].action="getSeeHouseOrder?curPage="+curPage+"&pageSize="+pageSize;
			document.forms["houseOrderForm"].submit();
		}
	});
...
<body>
	<form name="houseOrderForm" method="post">
