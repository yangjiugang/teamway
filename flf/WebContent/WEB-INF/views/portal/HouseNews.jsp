...
$(document).ready(function(){
	...
	function goPage(curPage, pageSize) {
		window.location.href="houseNews?houseId=${houseInfo.houseId }&page="+curPage+"&pageSize="+pageSize; 
	}
});
</script>
</head>
  ...
  <div class="conter">
	...
	<%@include file="HouseInfoTopMeun.jsp" %>
		...
		<!--详情介绍-->
		  <div class="jiages">
		    <dl>
		    <c:forEach items="${houseNews }" var="news" varStatus="status">
			  <dt>
				  <a href="newsInfo?newsId=${news.newsId }">
				  	<fmt:formatDate value="${news.infoCreateDate}" pattern="MM月dd日" type="date"/>
				  </a>
			  </dt>
			  <dd><a href="newsInfo?newsId=${news.newsId }">${news.infoTitle}</a></dd>
			 </c:forEach>
			</dl>
		  </div>
		...
		<!--详情介绍-->
		<div class="clear"><div id="fenye"></div></div>
			<div class="con-bot">
		  <div class="con-bot-l">
		    <ul>
