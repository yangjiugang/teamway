        ...
        <span class="selectRight">
          ...
          <div class="multiple">
             ...
             <form>
                ...
                <a href="../monopolyofsaleM2.html"><img  src="images/seachBut1.jpg" class="selectBut" style="margin-left:5px;"/></a>
              </form>
           </div>
        </span>
    </div>
     ...
     <div class="conter-con">
	  ...
	  <%@include file="HouseInfoTopMeun.jsp" %>
		...
		<c:forEach items="${photoList }" var="photo" varStatus="status">
			<div class="banner-a"><img src="${photo.picDetailPath }" />原图尺寸：923x412　 <a href="#" class="grey">查看原图</a></div>
		</c:forEach>
	   </div>
	 </div>
	</div>
