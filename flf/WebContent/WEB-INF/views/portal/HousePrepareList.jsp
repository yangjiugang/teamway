...
<div class="SelectOut">
  ...
  <div class="conter">
	...
	<%@include file="HouseInfoTopMeun.jsp" %>
		...
		<div class="xingp-l">
          ...
          <div class="grapxq">
		   <div class="grapxq-tel">
		    <span class="bm">交通<span class="grey">(${fn:length(map.picType9)}张)</span></span>
			<span class="tm"><a href="index1.html" class="red">查看全部>></a></span>	           </div>
			<div class="grapxq-con">
			  <ul>
			  <c:forEach items="${map.picType9}" var="picType9" end="3" varStatus="status">
			    	<li><a href="index1.html"><img src="${type9.picPath} border="0" /><span class="red">${type9.picDesc }</span></a></li>
			 </c:forEach>
			  </ul>
			</div>
		</div>
		...
		<div class="grapxq">
		   <div class="grapxq-tel">
		    <span class="bm">医疗<span class="grey">(${fn:length(map.picType10)}张)</span></span>
			<span class="tm"><a href="index1.html" class="red">查看全部>></a></span>	           </div>
			<div class="grapxq-con">
			  <ul>
			   <c:forEach items="${map.picType10}" var="picType10" end="3" varStatus="status">
			    	<li><a href="index1.html"><img src="${type10.picPath} border="0" /><span class="red">${type10.picDesc }</span></a></li>
			 </c:forEach>
			  </ul>
			</div>
		</div>
		...
		<div class="grapxq">
		   <div class="grapxq-tel">
		    <span class="bm">学校<span class="grey">(${fn:length(map.picType11)}张)</span></span>
			<span class="tm"><a href="index1.html" class="red">查看全部>></a></span>	           </div>
			<div class="grapxq-con">
			  <ul>
			    <c:forEach items="${map.picType11}" var="picType11" end="3" varStatus="status">
			    	<li><a href="index1.html"><img src="${type11.picPath} border="0" /><span class="red">${type11.picDesc }</span></a></li>
			 	</c:forEach>
			  </ul>
			</div>
		</div>
		...
		<div class="xingp-r">
		   ...
		   <div class="grapxp-tel">
		    <span class="bm">生活设施<span class="grey">(${fn:length(map.picType12)}张)</span></span>
	           </div>
			<div class="grapxp-con">
			  <ul>
			  <c:forEach items="${map.picType12}" var="picType12" end="3" varStatus="status">
			    <li><a href="index1.html"><img src="${type12.picPath}" border="0" /><span class="red">${type12.picDesc }</span></a></li>
			</c:forEach>
				<li class="tm"><a href="index1.html" class="red">查看全部>></a></span></li>
			  </ul>
			</div>
		</div>
		</div>	
