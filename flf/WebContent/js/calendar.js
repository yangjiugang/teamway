 ...
 * @param   endYear             2010
 * @param   language            zh_CN|en_US|zh_TW   注意：要区分大小写
...
Calendar.prototype.draw = function() {
	...
	this.form.selectTodayButton.onclick = function () {
		...
		if(calendar.otherdateControl1){
			calendar.otherdateControl1.value = calendar.dateControl.value;
		}
		calendar.hide();
	}
};
...
Calendar.prototype.show = function (dateControl, popuControl, otherdateControl1) {
	...
	this.otherdateControl1 = otherdateControl1;
...
Calendar.prototype.getAbsPoint = function (e){
	...
	var sHeight = window.document.body.scollHeight;
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #666666;width:168px;height:190px;">');
...
__ci.document.writeln('body {font-size:10px;margin:0px;text-align:center;}');
...
__ci.document.writeln('th.theader {font-weight:normal;background-color:#666666;color:#FFFFFF;width:18px;}');
__ci.document.writeln('select.year {width:58px;}');
...
__ci.document.writeln('input.l {border: 0px solid #CCCCCC;background-color:#EFEFEF;width:12px;height:12px;}');
__ci.document.writeln('input.r {border: 0px solid #CCCCCC;background-color:#EFEFEF;width:13px;height:12px;}');
__ci.document.writeln('input.b {border: 0px solid #CCCCCC;background-color:#EFEFEF;width:100%;height:18px;}');
__ci.document.writeln('-->');
