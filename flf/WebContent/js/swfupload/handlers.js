...
function addReadyFileInfo(fileid,fileName,message,status){
	...
	col1.style.width="150;background-color: #C5D9FF;";
	col2.style.width="250;background-color: #C5D9FF;";
	col3.style.width="80;background-color: #C5D9FF;";
	col4.style.width="background-color: #C5D9FF;";
}
