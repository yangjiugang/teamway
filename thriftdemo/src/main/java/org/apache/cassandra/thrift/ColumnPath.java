...
public class ColumnPath implements org.apache.thrift.TBase<ColumnPath, ColumnPath._Fields>, java.io.Serializable, Cloneable, Comparable<ColumnPath> {
  ...
  public java.lang.String column_family; // required
  public java.nio.ByteBuffer super_column; // optional
  public java.nio.ByteBuffer column; // optional
  ...
  public ColumnPath setColumn_family(java.lang.String column_family) {
    this.column_family = column_family;
    return this;
  }
  ...
  public ColumnPath setSuper_column(java.nio.ByteBuffer super_column) {
  ...
  public ColumnPath setColumn(java.nio.ByteBuffer column) {
  ...
  public int compareTo(ColumnPath other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetColumn_family()).compareTo(other.isSetColumn_family());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSuper_column()).compareTo(other.isSetSuper_column());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSuper_column()) {
