...
public class CqlMetadata implements org.apache.thrift.TBase<CqlMetadata, CqlMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<CqlMetadata> {
  ...
  public java.util.Map<java.nio.ByteBuffer,java.lang.String> name_types; // required
  public java.util.Map<java.nio.ByteBuffer,java.lang.String> value_types; // required
  public java.lang.String default_name_type; // required
  public java.lang.String default_value_type; // required
  ...
  public CqlMetadata setName_types(java.util.Map<java.nio.ByteBuffer,java.lang.String> name_types) {
    this.name_types = name_types;
    return this;
  }
  ...
  public CqlMetadata setValue_types(java.util.Map<java.nio.ByteBuffer,java.lang.String> value_types) {
    this.value_types = value_types;
    return this;
  }
  ...
  public CqlMetadata setDefault_name_type(java.lang.String default_name_type) {
    this.default_name_type = default_name_type;
    return this;
  }
  ...
  public CqlMetadata setDefault_value_type(java.lang.String default_value_type) {
    this.default_value_type = default_value_type;
    return this;
  }
  ...
  public int compareTo(CqlMetadata other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetName_types()).compareTo(other.isSetName_types());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetValue_types()).compareTo(other.isSetValue_types());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetValue_types()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDefault_name_type()).compareTo(other.isSetDefault_name_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDefault_name_type()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDefault_value_type()).compareTo(other.isSetDefault_value_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDefault_value_type()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.name_types = new java.util.HashMap<java.nio.ByteBuffer,java.lang.String>(2*_map138.size);
                java.nio.ByteBuffer _key139;
                java.lang.String _val140;
                for (int _i141 = 0; _i141 < _map138.size; ++_i141)
                {
                  _key139 = iprot.readBinary();
                  _val140 = iprot.readString();
                  struct.name_types.put(_key139, _val140);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.value_types = new java.util.HashMap<java.nio.ByteBuffer,java.lang.String>(2*_map142.size);
                ...
                for (int _i145 = 0; _i145 < _map142.size; ++_i145)
                {
                  ...
                  struct.value_types.put(_key143, _val144);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CqlMetadata struct) throws org.apache.thrift.TException {
      ...
      if (struct.name_types != null) {
        oprot.writeFieldBegin(NAME_TYPES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, java.lang.String> _iter146 : struct.name_types.entrySet())
          {
      ...
      if (struct.value_types != null) {
        oprot.writeFieldBegin(VALUE_TYPES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, java.lang.String> _iter147 : struct.value_types.entrySet())
          {
  ...
  private static class CqlMetadataTupleScheme extends org.apache.thrift.scheme.TupleScheme<CqlMetadata> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, CqlMetadata struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.util.Map.Entry<java.nio.ByteBuffer, java.lang.String> _iter148 : struct.name_types.entrySet())
        {
      ...
      }
      {
        ...
        for (java.util.Map.Entry<java.nio.ByteBuffer, java.lang.String> _iter149 : struct.value_types.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CqlMetadata struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.name_types = new java.util.HashMap<java.nio.ByteBuffer,java.lang.String>(2*_map150.size);
        java.nio.ByteBuffer _key151;
        java.lang.String _val152;
        for (int _i153 = 0; _i153 < _map150.size; ++_i153)
        {
          _key151 = iprot.readBinary();
          _val152 = iprot.readString();
          struct.name_types.put(_key151, _val152);
        }
      }
      struct.setName_typesIsSet(true);
      {
        ...
        struct.value_types = new java.util.HashMap<java.nio.ByteBuffer,java.lang.String>(2*_map154.size);
        ...
        for (int _i157 = 0; _i157 < _map154.size; ++_i157)
        {
          ...
          struct.value_types.put(_key155, _val156);
        }
      }
      struct.setValue_typesIsSet(true);
      struct.default_name_type = iprot.readString();
