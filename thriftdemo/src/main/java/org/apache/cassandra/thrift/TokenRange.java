...
public class TokenRange implements org.apache.thrift.TBase<TokenRange, TokenRange._Fields>, java.io.Serializable, Cloneable, Comparable<TokenRange> {
  ...
  public java.lang.String start_token; // required
  public java.lang.String end_token; // required
  public java.util.List<java.lang.String> endpoints; // required
  public java.util.List<java.lang.String> rpc_endpoints; // optional
  public java.util.List<EndpointDetails> endpoint_details; // optional
  ...
  public TokenRange setStart_token(java.lang.String start_token) {
    this.start_token = start_token;
    return this;
  }
  ...
  public TokenRange setEnd_token(java.lang.String end_token) {
    this.end_token = end_token;
    return this;
  }
  ...
  public TokenRange setEndpoints(java.util.List<java.lang.String> endpoints) {
    this.endpoints = endpoints;
    return this;
  }
  ...
  public TokenRange setRpc_endpoints(java.util.List<java.lang.String> rpc_endpoints) {
  ...
  public TokenRange setEndpoint_details(java.util.List<EndpointDetails> endpoint_details) {
  ...
  public int compareTo(TokenRange other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetStart_token()).compareTo(other.isSetStart_token());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetEnd_token()).compareTo(other.isSetEnd_token());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEnd_token()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRpc_endpoints()).compareTo(other.isSetRpc_endpoints());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRpc_endpoints()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetEndpoint_details()).compareTo(other.isSetEndpoint_details());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEndpoint_details()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.endpoints = new java.util.ArrayList<java.lang.String>(_list40.size);
                java.lang.String _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = iprot.readString();
                  struct.endpoints.add(_elem41);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rpc_endpoints = new java.util.ArrayList<java.lang.String>(_list43.size);
                java.lang.String _elem44;
                for (int _i45 = 0; _i45 < _list43.size; ++_i45)
                {
                  _elem44 = iprot.readString();
                  struct.rpc_endpoints.add(_elem44);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.endpoint_details = new java.util.ArrayList<EndpointDetails>(_list46.size);
                EndpointDetails _elem47;
                for (int _i48 = 0; _i48 < _list46.size; ++_i48)
                {
                  _elem47 = new EndpointDetails();
                  _elem47.read(iprot);
                  struct.endpoint_details.add(_elem47);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenRange struct) throws org.apache.thrift.TException {
      ...
      if (struct.endpoints != null) {
        oprot.writeFieldBegin(ENDPOINTS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter49 : struct.endpoints)
          {
      ...
      if (struct.rpc_endpoints != null) {
        if (struct.isSetRpc_endpoints()) {
          oprot.writeFieldBegin(RPC_ENDPOINTS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter50 : struct.rpc_endpoints)
            {
  ...
  private static class TokenRangeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TokenRange> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TokenRange struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.end_token);
      {
        ...
        for (java.lang.String _iter52 : struct.endpoints)
        {
      ...
      if (struct.isSetRpc_endpoints()) {
        {
          ...
          for (java.lang.String _iter53 : struct.rpc_endpoints)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TokenRange struct) throws org.apache.thrift.TException {
      ...
      struct.setEnd_tokenIsSet(true);
      {
        ...
        struct.endpoints = new java.util.ArrayList<java.lang.String>(_list55.size);
        java.lang.String _elem56;
        for (int _i57 = 0; _i57 < _list55.size; ++_i57)
        {
          _elem56 = iprot.readString();
          struct.endpoints.add(_elem56);
        }
      }
      struct.setEndpointsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.rpc_endpoints = new java.util.ArrayList<java.lang.String>(_list58.size);
          java.lang.String _elem59;
          for (int _i60 = 0; _i60 < _list58.size; ++_i60)
          {
            _elem59 = iprot.readString();
            struct.rpc_endpoints.add(_elem59);
          }
        }
        struct.setRpc_endpointsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.endpoint_details = new java.util.ArrayList<EndpointDetails>(_list61.size);
          EndpointDetails _elem62;
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            _elem62 = new EndpointDetails();
            _elem62.read(iprot);
            struct.endpoint_details.add(_elem62);
          }
        }
        struct.setEndpoint_detailsIsSet(true);
      }
